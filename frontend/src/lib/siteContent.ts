...
export const defaultProfile: Required<Omit<ProfileRecord, 'id'>> = {
  ...
  hero_subtitle: "Je conçois des applications web modernes, rapides et évolutives avec une forte attention portée à la performance, à l’expérience utilisateur et à la qualité du code.",
...
export const fallbackSkills: SkillRecord[] = [
  { id: 15, name: 'java', category: 'Backend', mastery_percentage: 80, icon_name: 'openjdk', order: 0 },
  { id: 16, name: 'mysql', category: 'Backend', mastery_percentage: 80, icon_name: 'mysql', order: 0 },
  { id: 1, name: 'React', category: 'Frontend', mastery_percentage: 95, icon_name: 'react', order: 1 },
  { id: 3, name: 'Python', category: 'Backend', mastery_percentage: 95, icon_name: 'python', order: 1 },
  { id: 4, name: 'Django', category: 'Backend', mastery_percentage: 92, icon_name: 'django', order: 1 },
...
export const fallbackEducation: EducationRecord[] = [
  ...
  {
    id: 2,
    title: 'Baccalauréat Unique (Guinée)',
    institution: 'Lycée Facinet Béavogui',
    start_year: '2019',
    end_year: '2023',
  ...
  },
  {
    ...
    institution: 'Collège Sarakoléah',
    start_year: '2015',
    end_year: '2019',
  ...
  },
  {
    ...
    institution: 'École Primaire Condetta 2',
    start_year: '2007',
    end_year: '2014',
...
export const fallbackProjects: ProjectRecord[] = [
  {
    id: 3,
    title: 'Santelink',
    description: "SanteLink est une plateforme de santé numérique conçue pour faciliter l’accès aux services médicaux et améliorer la communication entre patients et professionnels de santé. Le projet intègre des fonctionnalités modernes comme la prise de rendez-vous, la consultation à distance et la gestion des informations médicales.",
    image_url: '/media/projects/Capture_d%C3%A9cran_2026-04-21_121153.png',
    stack: ["Django", "Python", "React", "TypeScript", "Docker", "PostgreSQL", "Redis", "Git", "Tailwind"],
    category: 'Full-Stack',
    link_github: '',
  ...
  },
  {
    id: 2,
    title: 'IdentiGuinée',
    description: "GN-10 IdentiGuinée est un projet orienté identité numérique et confiance digitale visant à proposer des solutions modernes de vérification et de gestion d’identité adaptées au contexte guinéen.",
...
export function usePublicProfile() {
  return useQuery({
    ...
    queryFn: async (): Promise<ProfileRecord | null> => {
      ...
      const timeout = setTimeout(() => controller.abort(), 60000); // 60s timeout for prod spin-up
