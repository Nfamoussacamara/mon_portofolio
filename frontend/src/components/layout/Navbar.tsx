  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between relative">
        ...
        {/* Mobile: centered social icons (visible only on small screens) */}
        <div className="md:hidden absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center gap-4 z-10">
